...
export declare function isReversibleIterable<T>(val: unknown): val is ReversibleIterable<T>;
/** Determines whether an iterable is a lazy reversible iterable */
export declare function isReversibleLazy<T>(val: unknown): val is LazyIterable<T> & ReversibleIterable<T>;
 ...
 */
export declare function lazy<Items>(source: Iterable<Items> | ReversibleIterable<Items>): LazyIterable<Items>;
export declare function lazyHelper<InItem, OutItem, InIter extends Iterable<InItem>>(iterable: InIter, callback: (iterable: Iterable<InItem>, reverse: boolean) => Iterable<OutItem>): LazyIterable<OutItem>;
export {};
