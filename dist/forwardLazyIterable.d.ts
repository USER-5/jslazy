 ...
 */
export declare function isForwardLazy<T>(val: Iterable<T>): val is ForwardLazyIterable<T>;
/**
 ...
 */
export declare function forwardLazyIterable<T>(source: Iterable<T>): ForwardLazyIterable<T>;
export {};
